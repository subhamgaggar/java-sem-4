...
public class NormalEmployee extends Employee {
    ...
    public NormalEmployee(String name, String uan, String employeeID, String pfNo, String designation, String esiNo, String department, String bankName, String doj, String bankAccountNo, double grossWage, int totalWorkingDays, int paidDays, int lopDays, int leavesTaken) {
