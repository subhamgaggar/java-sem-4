...
public class loginFrame extends JFrame implements ActionListener{
    ...
    JButton submitButton, forgotPasswordButton, newUserButton;
    ...
    public loginFrame(){
        ...
        //---------creating a PasswordTextFiedl for password--------
        ...
        submitButton.setBounds(105, 100, 100, 35);
        ...
        //-------creating a forgotPasswordButton-------
        forgotPasswordButton = new JButton("FORGOT PASSOWRD");
        forgotPasswordButton.addActionListener(this);
        forgotPasswordButton.setBounds(15, 160, 150, 35);
        forgotPasswordButton.setFont(new Font("Times", Font.BOLD, 13));
        forgotPasswordButton.setBackground(Color.BLACK);
        forgotPasswordButton.setForeground(new Color(24,27,97));
        forgotPasswordButton.setBorder(BorderFactory.createEtchedBorder());
        loginLabel2.add(forgotPasswordButton);
        
        
        
        //--------creating a newUserButton--------
        newUserButton = new JButton("NEW USER");
        newUserButton.addActionListener(this);
        newUserButton.setBounds(170, 160, 120, 35);
        newUserButton.setFont(new Font("Times", Font.BOLD, 13));
        newUserButton.setBackground(Color.BLACK);
        newUserButton.setForeground(new Color(24,27,97));
        newUserButton.setBorder(BorderFactory.createEtchedBorder());
        loginLabel2.add(newUserButton);
     ...
     public void actionPerformed(ActionEvent e){
         ...
         if(e.getSource() == submitButton){
             ...
             try{
                 ...
                 String query = "select * from userinfo where username = '"+usernameTextField.getText()+"' and password = '"+passwordTextField.getText()+"'";
